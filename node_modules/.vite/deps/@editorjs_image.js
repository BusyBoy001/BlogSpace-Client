...
var _ = ((C) => (C.Empty = "empty", C.Uploading = "uploading", C.Filled = "filled", C))(_ || {});
var D = class {
  /**
  ...
  fillImage(i) {
    ...
    let r = "load";
    a === "VIDEO" && (s.autoplay = true, s.loop = true, s.muted = true, s.playsinline = true, r = "loadeddata"), this.nodes.imageEl = S(a, this.CSS.imageEl, s), this.nodes.imageEl.addEventListener(r, () => {
      this.toggleStatus(
        "filled"
        /* Filled */
  ...
  (function(a, s) {
    ...
    return function(a) {
      ...
      function r(o) {
        ...
        return a[o].call(e.exports, e, e.exports, r), e.l = true, e.exports;
      }
      return r.m = a, r.c = s, r.d = function(o, e, d) {
        r.o(o, e) || Object.defineProperty(o, e, { enumerable: true, get: d });
      }, r.r = function(o) {
        ...
        if (r.r(d), Object.defineProperty(d, "default", { enumerable: true, value: o }), 2 & e && typeof o != "string") for (var v in o) r.d(d, v, (function(l) {
          return o[l];
        }).bind(null, v));
        return d;
      }, r.n = function(o) {
      ...
      }, e.title = "browser", e.browser = true, e.env = {}, e.argv = [], e.version = "", e.versions = {}, e.on = c, e.addListener = c, e.once = c, e.off = c, e.removeListener = c, e.removeAllListeners = c, e.emit = c, e.prependListener = c, e.prependOnceListener = c, e.listeners = function(u) {
        return [];
...
var P = class _P {
  ...
  render() {
    var i, a, s;
    return (((i = this.config.features) == null ? void 0 : i.caption) === true || ((a = this.config.features) == null ? void 0 : a.caption) === void 0 || ((s = this.config.features) == null ? void 0 : s.caption) === "optional" && this.data.caption) && (this.isCaptionEnabled = true, this.ui.applyTune("caption", true)), this.ui.render();
  }
  /**
  ...
  renderSettings() {
    ...
    const s = i.filter((e) => {
      ...
      return d === "caption" ? ((v = this.config.features) == null ? void 0 : v.caption) !== false : d == null || ((l = this.config.features) == null ? void 0 : l[d]) !== false;
    }), r = (e) => {
    ...
    return s.map((e) => ({
      ...
      onActivate: () => {
        ...
        let d = !r(e);
        e.name === "caption" && (this.isCaptionEnabled = !(this.isCaptionEnabled ?? false), d = this.isCaptionEnabled), this.tuneToggled(e.name, d);
      }
    }));
  }
  /**
  ...
  set data(i) {
    ...
    this.image = i.file, this._data.caption = i.caption || "", this.ui.fillCaption(this._data.caption), _P.tunes.forEach(({ name: s }) => {
      ...
      this.setTune(s, r);
    }), i.caption ? this.setTune("caption", true) : ((a = this.config.features) == null ? void 0 : a.caption) === true && this.setTune("caption", true);
  }
  /**
   * Return Tool data
   */
   ...
   */
  tuneToggled(i, a) {
    i === "caption" ? (this.ui.applyTune(i, a), a == false && (this._data.caption = "", this.ui.fillCaption(""))) : this.setTune(i, a);
  }
  /**
   * Set one tune
